...
tech_indicator_list = np.load('E:/DS340/MacroHFT/data/feature_list/single_features.npy', allow_pickle=True).tolist()
tech_indicator_list_trend = np.load('E:/DS340/MacroHFT/data/feature_list/trend_features.npy', allow_pickle=True).tolist()
...
class Testing_Env(gym.Env):
    ...
    def step(self, action):
        ...
        if self.m % 1000 == 0:
            print(self.m, '/', len(self.df.index.unique()) - 1)
